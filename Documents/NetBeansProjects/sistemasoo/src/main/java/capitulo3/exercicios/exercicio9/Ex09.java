/*
 *
 * Faça um programa que solicite ao usuário o tamanho dos lados
 * de um triângulo. O programa deverá imprimir a classificação
 * do triângulo quanto aos lados (equilátero, isósceles ou escaleno).
 * 
 */
